...
public class PaymentTestDataUtil {
    //PaymentReceipt
    public static PaymentReceipt createPaymentReceiptA(Order order) {
        PaymentReceipt paymentReceipt = new PaymentReceipt();
        paymentReceipt.setOrder(order);
        paymentReceipt.setRuc("10011742152");
        paymentReceipt.setTotalWithoutTax(114.2);
        paymentReceipt.setTaxes(34.5);
    ...
    public static PaymentReceipt createPaymentReceiptB(Order order) {
        PaymentReceipt paymentReceipt = new PaymentReceipt();
        paymentReceipt.setOrder(order);
        paymentReceipt.setRuc("10011722222");
        paymentReceipt.setTotalWithoutTax(214.2);
        paymentReceipt.setTaxes(64.5);
    ...
    public static PaymentReceipt createPaymentReceiptC(Order order) {
        PaymentReceipt paymentReceipt = new PaymentReceipt();
        paymentReceipt.setOrder(order);
        paymentReceipt.setRuc("10011755555");
        paymentReceipt.setTotalWithoutTax(314.2);
        paymentReceipt.setTaxes(84.5);
